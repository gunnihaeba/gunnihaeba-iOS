...
struct MyguniEditView: View {
    ...
    func submitPost(title: String, content: String) {
            ...
            let url = "http://13.125.220.50:8080/issue/\(postId)"
        

            AF.request(url, method: .patch, parameters: parameters, encoding: JSONEncoding.default, headers: [.authorization(bearerToken: LoginUserHashCache.shared.checkAccessToken() ?? LoginUserHashCache.accessToken)])
...
#Preview {
    MyguniEditView(postId: 1, title: "", content: "")
}
